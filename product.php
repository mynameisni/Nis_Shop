				...
				<div class="row">
					<div class="col-12">
						<div class="section-title">
							...
							<table>
				                <tr>
				                    <td class="td1"><b> Sort by price: </b></td>
				                    <td class="td2"><input type="radio" name="sort" value="asc" <?php if(isset($_POST["sort"]) && $sort=="asc")
				                                                    echo 'checked'; ?>> Low to high </td>
				                    <td class="td2"><input type="radio" name="sort" value="desc" <?php if(isset($_POST['sort']) && $sort=="desc")
				                                                    echo "checked"; ?>> High to low </td>
				                    <td class="td3" style="align: left"><input type="submit" name="filter" value="Filter"></td>
				                </tr>
				            </table>
						</div>
					</div>
										...
										<div class="row">
											<?php
									            ...
									            if(!isset($_POST['filter']) || !isset($_POST['sort'])){
									                ...
									                } else {$sql="select * from `products` order by `price` desc"; }
									            }
									            $dl=$conn-> query($sql); 
									            foreach ($dl as $value) {
									        ?>
												...
												<div class="single-product">
													<div class="product-img">
														<a data-toggle="modal" data-target="#exampleModal" >
															<img class="default-img" src="images/<?php echo $value[3]?>.png">
														</a>
														<div class="button-head">
															<div class="product-action">
																<a data-toggle="modal" data-target="#exampleModal" title="Quick View"><i class=" ti-eye"></i><span> View </span></a>
