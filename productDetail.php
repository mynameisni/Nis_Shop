...
<body class="js">
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li><a href="product.php"> Product <i class="ti-arrow-right"></i></a></li>
	...
	if (isset($_GET['id_product'])) {
		$sqlSelectP = "SELECT * FROM `products` WHERE id_product =".$_GET['id_product'];
		$result = mysqli_query($conn, $sqlSelectP) or die("Error");
	...
	<section id="contact-us" class="contact-us section">
		<div class="container">
			<div class="contact-head">
				<div class="row">
					<div class="col-md-6">
						<img src="images/<?php echo $row['image'];?>.png" width=80% height=80% >
					</div>
					<div class="col-md-6">
