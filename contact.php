...
<body class="js">
									...
									<div class="row">
										...
										<div class="col-12" style="margin-top:15px">
											<div class="form-group button">
												<button type="submit" class ="btn" onclick="sendEmail()" value="Send an Email"> Send Message </button>
											</div>
										</div>
									</div>
								</form>
	...
	<script>
		function sendEmail(){
			...
			if(isNotEmpty(name) && isNotEmpty(email) && isNotEmpty(subject) && isNotEmpty(phone) && isNotEmpty(message) ){
				$.ajax({
					url: "sendEmail.php",
					method: "POST",
					dataType: "json",
