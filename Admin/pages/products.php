    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="../pages/products.php">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="card-body">
                        <div class="table-responsive p-0">
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    <?php
                                        $sqlSelect = "SELECT * FROM `products` JOIN `category` ON products.id_category = category.id_category ORDER BY 'date_add' ASC";
                                    ...
                                    <tr >
                                        ...
                                        <td> 
                                            <h6 class="mb-0 text-sm"> <?php echo $r['product_name']; ?> </h6>
                                        </td>
                                        <td align="center">
                                            <p class="mb-0"> <?php echo $r['type_name']; ?> </p>
                                        </td>
                                        <td>
